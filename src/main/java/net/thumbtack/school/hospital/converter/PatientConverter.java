...
public class PatientConverter {
    ...
    public CountOfBusyAppointmentsResponse inflateWithCountOfBusyAppointmentsResponse(Patient patient, int count) {
        return new CountOfBusyAppointmentsResponse(patient.getId(), patient.getFirstName(), patient.getLastName(), patient.getPatronymic(), patient.getEmail(), patient.getAddress(), patient.getPhone(), count);
    }

    public BusyTicketsResponse inflateWithBusyTicketsResponse(Patient patient, List<TicketResponse> tickets) {
        return new BusyTicketsResponse(patient.getId(), patient.getFirstName(), patient.getLastName(), patient.getPatronymic(), patient.getEmail(), patient.getAddress(), patient.getPhone(), tickets);
    }
